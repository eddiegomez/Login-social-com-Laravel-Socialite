                        ...
                        <form action="{{ route('login') }}" method="POST">
                            ...
                            <div class="form-group py-2">
                                <div class="input-field"> <span class="far fa-user p-2"></span>
                                    <input type="text" class="form-control @error('email') is-invalid @enderror" name="email" placeholder="Nome de usuário ou email" value="{{ old('email') }}" required autocomplete="email" required> </div>
                                    @error('email')
